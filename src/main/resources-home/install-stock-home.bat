...
java -jar %SOURCE_PATH%\src\main\resources\bin\antlr-4.10.1-complete.jar -encoding UTF8 -package kr.andold.stock.antlr -visitor -o %SOURCE_PATH%\src\main\java\kr\andold\stock\antlr %SOURCE_PATH%\src\main\resources\grammar\KrxEtf.g4
...
java -jar %SOURCE_PATH%\src\main\resources\bin\antlr-4.10.1-complete.jar -encoding UTF8 -package kr.andold.stock.antlr -visitor -o %SOURCE_PATH%\src\main\java\kr\andold\stock\antlr %SOURCE_PATH%\src\main\resources\grammar\SeibroEtf.g4
