...
public interface StockListener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	void enterSeibroPriceCompany(StockParser.SeibroPriceCompanyContext ctx);
	/**
	 * Exit a parse tree produced by {@link StockParser#seibroPriceCompany}.
	 * @param ctx the parse tree
	 */
	void exitSeibroPriceCompany(StockParser.SeibroPriceCompanyContext ctx);
	/**
	 * Enter a parse tree produced by {@link StockParser#seibroPriceEtf}.
	 * @param ctx the parse tree
	 */
	void enterSeibroPriceEtf(StockParser.SeibroPriceEtfContext ctx);
	/**
	 * Exit a parse tree produced by {@link StockParser#seibroPriceEtf}.
	 * @param ctx the parse tree
	 */
	void exitSeibroPriceEtf(StockParser.SeibroPriceEtfContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link StockParser#krxPriceEtf}.
	 * @param ctx the parse tree
	 */
	void enterKrxPriceEtf(StockParser.KrxPriceEtfContext ctx);
	/**
	 * Exit a parse tree produced by {@link StockParser#krxPriceEtf}.
	 * @param ctx the parse tree
	 */
	void exitKrxPriceEtf(StockParser.KrxPriceEtfContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link StockParser#krxItemInfoEtf}.
	 * @param ctx the parse tree
	 */
	void enterKrxItemInfoEtf(StockParser.KrxItemInfoEtfContext ctx);
	/**
	 * Exit a parse tree produced by {@link StockParser#krxItemInfoEtf}.
	 * @param ctx the parse tree
	 */
	void exitKrxItemInfoEtf(StockParser.KrxItemInfoEtfContext ctx);
	/**
